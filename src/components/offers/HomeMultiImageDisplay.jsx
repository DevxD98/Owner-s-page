...
/**
 * HomeMultiImageDisplay component - Shows a single image for each offer on the homepage
 * Optimized version of MultiImageDisplay for the homepage
 */
const HomeMultiImageDisplay = ({ offerType, title, id, image, isSponsored }) => {
  ...
  if (typeof offerImage === 'string' && offerImage.includes('unsplash.com')) {
    // Use better sized image for proper display - consistent height for all offers
...
export default HomeMultiImageDisplay;